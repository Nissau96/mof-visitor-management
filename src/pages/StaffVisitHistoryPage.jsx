...
function normalizeHistoryResult(result) {
  ...
  if (!validPagination || !validVisits) {
    throw new Error(
      "Visit history returned an invalid response.",
    );
  }
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
      <header className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-4 max-w-2xl leading-7 text-slate-600">
            Review authorised visit records using status,
        ...
        >
          ...
          <div className="grid gap-2">
            ...
            <div className="relative">
              ...
              <input
                className="min-h-12 w-full rounded-xl border border-slate-300 bg-white px-4 pl-12 text-base text-slate-950 shadow-sm outline-none focus:border-brand-700 focus:ring-4 focus:ring-brand-100"
          ...
          <div className="flex flex-wrap gap-3 md:col-span-2 lg:col-span-3">
            ...
            {filtersApplied ? (
              <button
                className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white px-5 font-bold text-slate-800 hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-60"
                disabled={loading}
      ...
      {history && status !== "error" ? (
        <section
          aria-busy={loading}
          aria-labelledby="visit-history-heading"
          ...
          {history.visits.length === 0 ? (
            <div className="p-5 sm:p-8">
              <div className="rounded-2xl bg-slate-50 p-6 text-center">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  No visit matches the current search and
                  filters.
                </p>
              </div>
            </div>
    ...
    <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <dl className="mt-5 grid gap-4 text-sm">
        <HistoryDetail
          icon={Phone}
          label="Phone"
          value={visit.phone || "Not provided"}
        />
        ...
        <HistoryDetail
          icon={Users}
          label="Purpose"
          value={`${visit.purpose} — ${getVisitContact(
            visit,
          )}`}
        />
...
function Pagination({
  ...
  return (
    <nav
      aria-label="Visit history pages"
