      ...
      <main className="mx-auto grid w-full max-w-5xl gap-8 px-4 py-8 sm:px-6 sm:py-12 lg:grid-cols-[1fr_1.1fr] lg:items-center lg:px-8">
        <section className="hidden rounded-3xl bg-brand-900 p-8 text-white lg:block">
          ...
          <p className="mt-6 text-sm leading-6 text-brand-100">
            Visitor information must be accessed only for
            approved operational and security purposes.
          </p>
        </section>
        ...
        >
          ...
          <p className="mt-3 leading-7 text-slate-600">
            Use your authorised staff account. Visitor
          ...
          >
            ...
            <button
              className="inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-brand-800 px-5 font-bold text-white transition hover:bg-brand-900 focus:outline-none focus:ring-4 focus:ring-brand-200 disabled:cursor-not-allowed disabled:opacity-70"
              disabled={isSubmitting}
              type="submit"
            >
              {isSubmitting ? (
          ...
          <div className="mt-6 border-t border-slate-200 pt-5">
            <Link
              className="inline-flex min-h-11 items-center rounded-xl font-bold text-brand-800 hover:text-brand-950"
              to="/visit"
            >
